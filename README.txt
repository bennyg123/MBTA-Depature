...
Steps to build:
    1. run either `yarn run build` or `npm run build`

Steps to build and server
    1. run either `yarn run build-serve` or `npm run build-serve`

Steps to serve
    1. run either `yarn run build` or `npm run build`
    2. run either `yarn run serve` or `npm run serve`
...
Please let me know if you have any difficulty running this application. 
